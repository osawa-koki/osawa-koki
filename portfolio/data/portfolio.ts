...
const portfolio: Portfolio[] = [
  ...
  },
  {
    ...
    description: "🍠🍠🍠 C++でポートスキャンを実行するプログラムを開発しました。",
  ...
  {
    name: "mandelbrot.py",
    description: "📍📍📍 Pythonでマンデルブロ集合を描写するプログラムを作成しました。",
  ...
  {
    name: "julia.py",
    description: "📌📌📌 Pythonでジュリア集合を描写するプログラムを作成しました。",
  ...
  },
  {
    ...
    description: "🦍🦍🦍 PythonでTCPクライアントとTCPサーバの通信を行うプログラムを作成しました。",
  ...
  },
  {
    ...
    description: "💻💻💻 Pythonでポートスキャンを実行するプログラムを開発しました。",
