...
const setting = {
  ...
  works: [
    {
      title: 'ECサイト構築事業者のセキュリティ系部門',
      startDate: dayjs('2022-04'),
      endDate: dayjs('2023-03'),
      description: 'ECサイト構築事業者のセキュリティ系部門で、WEBアプリケーションに起因する脆弱性の診断・対策を行っていました。',
      projects: [
        {
          title: 'SQLインジェクション対策',
    ...
    {
      title: 'セキュリティオートメーションツール開発事業者の開発系部門',
      startDate: dayjs('2023-04'),
      endDate: null,
      description: 'セキュリティオートメーションツール開発事業者の開発系部門で、セキュリティオートメーションツールの設計・開発を行っています。',
      projects: [
        {
          title: '新規格対応のための機能追加',
